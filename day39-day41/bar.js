...
// 拿到柱状图中的最大值Max，也可用下面的排序的方式得到最大值
    ...
    var percent = axisY/max;
    var colorArr = ['60acfc', '32d3eb', '5bc49f', 'feb64d', 'ff7c7c',
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var rectStartY = startY - data[i]*percent;

        var bar = "<rect x=" + rectStartX + " y=" + rectStartY + " width=" + barWidth + " height=" + percent*data[i] + ' style="fill:#0DAFF4;stroke-width:1;stroke:rgb(0,0,0)"/>';
        svgT += bar;
    }
    svgT += svgEnd;
...
function getLine(data) {
    ...
    var drawing = document.querySelector('#canvas1');
